...
resolve_layout_path(const std::filesystem::path& override_path) noexcept;
...
[[nodiscard]] bool prepare_layout_path(const std::filesystem::path& path,
                                       std::string& diagnostic) noexcept;

[[nodiscard]] bool remove_layout_file(const std::filesystem::path& path,
                                      std::string& diagnostic) noexcept;
